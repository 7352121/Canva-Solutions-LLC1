...
const Hero = () => {
    ...
    return (
        ...
        <div className="relative min-h-[100dvh] w-full bg-gradient-to-b from-[#020617] to-[#172554] flex items-center justify-center p-2 sm:p-4">
            ...
            {/* ✅ FIXED: Changed lg:h-[96vh] to h-auto and min-h-[90vh] to allow content to breathe */}
            <div className="relative z-10 w-full lg:w-[98%] min-h-[90vh] h-auto lg:min-h-[96vh] bg-black/20 rounded-[20px] sm:rounded-[30px] border border-white/10 shadow-2xl flex flex-col overflow-hidden pb-8 lg:pb-0">
                ...
                {/* CONTENT */}
                <div className="relative z-10 max-w-[1632px] h-full flex flex-col px-4 sm:px-10 lg:px-16 pt-4">

                    <Navbar />

                    {/* ✅ Adjusted flex-grow to handle smaller laptop screens */}
                    <div className="flex-grow flex flex-col justify-center py-10 lg:py-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                            ...
                            <div className="space-y-6 sm:space-y-8 max-w-2xl mx-auto lg:mx-0 flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                {/* ✅ Responsive Typography scaled for laptops */}
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-4 pt-2 w-full sm:w-auto">
                                    ...
                                    >
                                        <PrimaryButton className="w-full justify-center py-3 lg:py-4 text-lg px-8">
                                            Get Started
                                        </PrimaryButton>
                                    </a>
                                    
                                    <Link to="/services" className="w-full sm:w-auto">
                                        <SecondaryButton className="justify-center w-full py-3 lg:py-4 text-lg px-8">
                                            See Process
                                        </SecondaryButton>
                                    </Link>
                                </div>
                            ...
                            <div className="flex h-full items-center justify-center lg:items-end lg:justify-end lg:pb-12 mt-8 lg:mt-0">
                                    ...
                                    <div className="flex items-center justify-center lg:justify-start gap-4">
                                        <div className="flex -space-x-3">
                                            {clientImages.map((imgSrc, index) => (
                                                <img key={index} src={imgSrc} alt="Client" className="w-10 h-10 rounded-full border-2 border-[#020617] object-cover" />
                                            ))}
                                        </div>
